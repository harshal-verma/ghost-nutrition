export const productsArray = [
    ...
    {
        id: 2,
        image: 'https://cdn.shopify.com/s/files/1/2060/6331/products/BCAAV2LemonCrush.png?v=1601922160',
        name: 'Ghost BCCA',
        description: 'Although traditionally taken during a workout or intense training session, GHOST® BCAA can be enjoyed around the clock as a phenomenal performance alternative to sugary sports drinks or juices.',
        details: "GHOST® Full Disclosure Label				All GHOST® products feature a 100% transparent label that fully discloses the dose of each active ingredient. Zero proprietary blends means you know what you’re getting in each and every scoop.				BCAAs 7G				GHOST® BCAA delivers a massive 7G Vegan Fermented 2:1:1 BCAAs (3500MG Leucine, 1750MG Isoleucine and 1750MG Valine) per scoop.",
        price: 20,
        type: 'Muscle Builder',
        wishlisted: false
    },
    ...
    },
    {
        ...
        name: 'Ghost Legend',
        description: "We aren’t the type to make crazy claims or talk nuanced product specifications (there’s this thing called the internet for those that want to research). All you need to know is that GHOST LEGEND® packs more than 2x of the stuff you care about most into every scoop than most “leading” pre-workouts.",
        details: "Citrulline is one of the best pump ingredients on the market. Most brands elect to stick Citrulline in a proprietary blend, under dose the compound or use ‘Citrulline Malate,’ which today is no more than a blend of L-Citrulline and Malic Acid, often in an undisclosed ratio. In fact, the 4 grams of L-Citrulline per scoop in GHOST Legend® is equivalent to the L-Citrulline content of 8 grams of Citrulline Malate! Pure L-Citrulline may be more expensive, but anecdotally provides better pumps without the potential for stomach discomfort caused by the additional acid.",
        price: 30,
        type: 'Muscle Builder',
        wishlisted: false
    },
    {
        ...
        name: 'Ghost Pump',
        description: "Full disclosure—the GHOST® fam is obsessed with nitric oxide products and we're not playing around when we say GHOST® Pump is the greatest...ever. After more than a year in the making, GHOST® Pump is here delivering more of everything—better ingredients (including the patented NO3-T®, GlycerSize™",
    ...
    },
    {
        ...
        description: "The May Capsule “GLITCH” and the GLITCH Tee released Thursday, May 28, exclusively online and at 12PM CT.Lorem ipsum dolor sit amet, consectetur adipiscing elit.",
